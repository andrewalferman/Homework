...
x.grid(which='both')
pyl.scatter(data[:, 0], data[:, 1], label='Serial CPU (flip)')
pyl.scatter(data[:, 0], data[:, 2], label='Parallel (OpenMP) CPU (flip)')
pyl.scatter(data[:, 0], data[:, 3], label='Parallel (SIMD) CPU (flip)')
pyl.scatter(CLdata[:, 0], CLdata[:, 1], label='Serial CPU (rabbit)')
pyl.scatter(CLdata[:, 0], CLdata[:, 2], label='Parallel (OpenMP) CPU (rabbit)')
pyl.scatter(CLdata[:, 0], CLdata[:, 3], label='Parallel (OPENCL) GPU')
