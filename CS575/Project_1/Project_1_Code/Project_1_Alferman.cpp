...
int main( int argc, char *argv[ ] )
{
  ...
  for( int i = 0; i < NUMNODES*NUMNODES; i++ )
  {
    ...
    float partialVolume = fullTileArea * Height(iu, iv);
  ...
  double megaHeight = (double)(NUMNODES*NUMNODES)/(time1-time0)/1000000.;

  printf("Performance: %8.4lf megaHeights/second\n", megaHeight );
  printf("Volume = %8.4lf \n", volume);
