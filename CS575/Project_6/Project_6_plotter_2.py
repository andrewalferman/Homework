...
pyl.xlabel('Global Work Size (kB)')
...
pyl.savefig('Mult_Arraysize_2.pdf', bbox_extra_artists=(lgd,),
            bbox_inches='tight')
pyl.cla()
...
pyl.xlabel('Local Work Size (bytes)')
pyl.ylabel('Speed (GigaCalcs/second)')
x.grid(which='both')
...
lgd = x.legend(handles, labels, bbox_to_anchor=(1.05, 1), loc=2, ncol=1,
               prop={'size':8})
fig.subplots_adjust(right=0.75)
pyl.savefig('Mult_Localsize_2.pdf', bbox_extra_artists=(lgd,),
            bbox_inches='tight')
pyl.cla()
...
lgd = x.legend(handles, labels, bbox_to_anchor=(1.05, 1), loc=2, ncol=1)
fig.subplots_adjust(right=0.75)
pyl.savefig('Mult_Reduc_Arraysize_2.pdf', bbox_extra_artists=(lgd,),
            bbox_inches='tight')
pyl.cla()
...
lgd = x.legend(handles, labels, bbox_to_anchor=(1.05, 1), loc=2, ncol=1)
fig.subplots_adjust(right=0.75)
pyl.savefig('Mult_Reduc_Localsize_2.pdf', bbox_extra_artists=(lgd,),
            bbox_inches='tight')
